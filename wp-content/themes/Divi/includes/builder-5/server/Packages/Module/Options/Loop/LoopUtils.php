...
class LoopUtils {
	 ...
	 */
	public static function build_current_page_query_args( int $posts_per_page, int $offset, string $context_url = '' ): array {
		$query_args = [
		...
		// In REST requests, archive context is often unavailable. Use the current page URL as fallback.
